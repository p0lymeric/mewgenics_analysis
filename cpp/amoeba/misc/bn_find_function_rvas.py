...
signatures = {
    ...
    'ADDRESS_glaiel__HouseCat__unk_remove_from_world': DirectSig('40 57 48 83 EC 30 48 8B 05 ?? ?? ?? ?? 48 8B F9 48 8B 91 80 00 00 00 48 89 5C 24 48 48 8B 88 98 05 00 00', 0),
