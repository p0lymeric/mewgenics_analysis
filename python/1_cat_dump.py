...
def main():
    ...
    for k, v in sorted(cats.items()):
        ...
        lover_affinity = v.lover_affinity()
        aggression = v.aggression()
        hater_sql_key = v.hater_sql_key()
        hater_affinity = v.hater_affinity()
        ...
        coi = v.coi()
        birthday = v.birthday()
        deathday_house = v.deathday_house()
        house_boss_kills = v.house_boss_kills()
        ...
        print(f'{lover_sql_key} {lover_affinity}')
        print(f'{aggression}')
        print(f'{hater_sql_key} {hater_affinity}')
        print(f'{fertility}')
        print(f'{body_parts}')
        ...
        print(f'{coi}')
        print(f'{birthday}')
        print(f'{deathday_house}')
        print(f'{house_boss_kills}')
        print(f'{lifestage}')
